...
from trcc.legacy.adapters.infra.dc_config import DcConfig
from trcc.legacy.adapters.infra.dc_parser import load_config_json
from trcc.legacy.services import MediaService, OverlayService
...
def start_video_playback(
    ...
    from trcc.legacy.adapters.infra.media_player import ThemeZtDecoder, VideoDecoder
    media = MediaService(
...
def start_screencast(
    ...
    if _is_wayland():
        from trcc.legacy.ui.gui.pipewire_capture import PIPEWIRE_AVAILABLE, PipeWireScreenCast
...
def mount_static_dirs(width: int, height: int) -> None:
    ...
    from trcc.legacy.core.paths import resolve_theme_dir
...
from trcc.legacy.ui.api.control_center import router as control_center_router  # noqa: E402
from trcc.legacy.ui.api.devices import router as devices_router  # noqa: E402
from trcc.legacy.ui.api.display import router as display_router  # noqa: E402
from trcc.legacy.ui.api.i18n import router as i18n_router  # noqa: E402
from trcc.legacy.ui.api.led import router as led_router  # noqa: E402
from trcc.legacy.ui.api.system import router as system_router  # noqa: E402
from trcc.legacy.ui.api.themes import router as themes_router  # noqa: E402
from trcc.legacy.ui.api.trcc import router as trcc_router  # noqa: E402
