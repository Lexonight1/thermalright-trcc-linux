...
from trcc.legacy.core.models import JPEG_MAX_BYTES, DetectedDevice, HardwareMetrics

if TYPE_CHECKING:
    from trcc.legacy.core.models import SensorInfo, UsbAddress
...
class Metrics(ABC):
    ...
    def __init__(self) -> None:
        ...
        """
        from trcc.legacy.core.models import HardwareMetrics as _HM
...
class Platform(ABC):
    ...
    def config_dir(self) -> str:
        ...
        from trcc.legacy.core.paths import USER_CONFIG_DIR
