...
<!-- audit-state: origin=2.0.3.0 addresses=2.1.8.2 known-bad=UCVideoCut.cs::ZhuanMaPanDuan -->
> **Audited against TRCC 2.0.3; citations re-anchored to TRCC 2.1.8.**
> 1 method(s) documented here changed in TRCC 2.1.8 and have NOT been re-read: `ZhuanMaPanDuan` — read those entries as TRCC 2.0.3 history.
