...
> 3 method(s) documented here changed in TRCC 2.1.8 and have NOT been re-read: `TouPingXianShiBackgroundImageSet90du`, `textBoxH_TextChanged`, `textBoxW_TextChanged` — read those entries as TRCC 2.0.3 history.
